...
#Region "Classes"
    ...
    Public Class class_Symbol
        ...
        Public Symbol_Table_Row As Integer
...
#Region "Get_Type, Get_Value, Set_Value, Get_Symbol"
    ...
    Public Function Get_Property(Source_Name As String) As Object
        Dim Idx As Integer
        ...
        If IsNothing(Source_Sym) Then
            If IsNothing(Source_Sym) Then
                Show_Error("Symbol not found : " & Source_Name)
                Return Nothing
            End If
        End If
    ...
    Private Sub Add_Symbol_To_Table(Buffer As String)
        ...
        Select Case Sym.Type
            Case enum_Symbol_Type.Button, enum_Symbol_Type.Toggle, enum_Symbol_Type.Label, _
                ...
                If Not Main_Form.Dont_Change_Controls_Properties Then
                ...
                If Sym.Type = enum_Symbol_Type.Text_Box Then
                    ...
                    If Sym.No_Edit Then
                        Sym.Change_Back_Color("White")
                    Else
                        Sym.Change_Back_Color("Azure")
                    End If
                ...
                If Not Main_Form.Dont_Change_Controls_Properties Then
                    ...
                    Sym.Font = Params(enum_Properties.Font)
                End If
                ...
                Form_Controls.Init_Control(Sym)
