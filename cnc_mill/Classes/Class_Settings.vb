...
Public Class Class_Settings
    ...
    Public Function Get_Setting(Key As String, Child_Key As String, Default_Value As Object, _
    ...
    Public Function Get_Control_Setting(Ctrl As Control, Child_Key As String, Optional Default_Value As Object = Nothing, _
...
#Region "Load/Save settings"
    ...
    Private Sub Load_Control(Contrl As Control, Values As Class_Settings, Update_Symbol As Boolean)
        ...
        Select Case Contrl.GetType.Name
            ...
            Case "ctl_GCode"
                gcd = Contrl
                gcd.GCode_File_Name = Values.Get_Control_Setting(Contrl, "File_Name", "", "String")
    ...
    Private Sub Save_Control(Contrl As Control, Values As Class_Settings)
        ...
        Select Case Contrl.GetType.Name
            ...
            Case "ctrl_GCode"
                gcode = Contrl
                Values.Put_Control_Setting(gcode, "File_Name", gcode.GCode_File_Name)
