...
#Region "Interface to main form"
    ...
    Public Sub Update_Positions()
        ...
        txt_Absolute_X.Text = Symbol.Get_Value("Sys.Abs_X")
        txt_Absolute_Y.Text = Symbol.Get_Value("Sys.Abs_Y")
        txt_Absolute_Z.Text = Symbol.Get_Value("Sys.Abs_Z")

        txt_Work_X.Text = Symbol.Get_Value("Sys.Work_X")
        txt_Work_Y.Text = Symbol.Get_Value("Sys.Work_Y")
        txt_Work_Z.Text = Symbol.Get_Value("Sys.Work_Z")

        txt_Delta_X.Text = Calc.Format_Number(Math.Abs(Symbol.Get_Value("Sys.Abs_X") - Start_X))
        txt_Delta_Y.Text = Calc.Format_Number(Math.Abs(Symbol.Get_Value("Sys.Abs_Y") - Start_Y))
        txt_Delta_Z.Text = Calc.Format_Number(Math.Abs(Symbol.Get_Value("Sys.Abs_Z") - Start_Z))
        ...
        Calc.Cartesian_To_Polar(Start_X, Start_Y, Symbol.Get_Value("Sys.Abs_X"), Symbol.Get_Value("Sys.Abs_Y"), Distance, Angle)
...
#End Region
    ...
    Private Sub btn_Set_Start_Click(sender As Object, e As EventArgs) Handles btn_Set_Start.Click
        Start_X = Calc.Round(Symbol.Get_Value("Sys.Abs_X"))
        Start_Y = Calc.Round(Symbol.Get_Value("Sys.Abs_Y"))
        Start_Z = Calc.Round(Symbol.Get_Value("Sys.Abs_Z"))
