...
#Region "Shown, Closing"
    ...
    Private Sub dlg_Wizards_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        ...
        Form_Controls.Make_Form_Buttons_Transparent(Me, Transparent_Color)
        ...
        ctl_Drawing.Initialize(Dwg_sym, Symbol.Get_Value("Sys.Max_X"), Symbol.Get_Value("Sys.Max_Y"), Symbol.Get_Value("Sys.Max_Z"), ctl_GCode)
        ctl_Drawing.Dock = DockStyle.Fill

        ctl_Drawing.Setup()
        ctl_GCode.GCode_File_Name = Wizard_GCode_File_Name
    ...
    Private Sub dlg_Wizards_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        ...
        Wizard_GCode_File_Name = ctl_GCode.GCode_File_Name
        ...
        If Changes_Made Then
            ...
            If Message_Box.DialogResult = Windows.Forms.DialogResult.Yes Then
                If ctl_GCode.GCode_File_Name = "" Then
                    Save_GCode_Dialog(ctl_GCode.GCode_File_Name)
                Else
                    Save_GCode(ctl_GCode.GCode_File_Name)
                    Changes_Made = False
                End If
            End If
...
#Region "Toolstrip"
    ...
    Private Sub ts_Wizard_ItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles ts_Wizard.ItemClicked
        ...
        Select Case e.ClickedItem.Text
            ...
            Case "Load"
                Load_GCode_Dialog(ctl_GCode.GCode_File_Name)
                Changes_Made = False
            ...
            Case "Save As"
                ...
                If Message <> "" Then
                    ...
                    If Message_Box.DialogResult = Windows.Forms.DialogResult.No Then Exit Sub
                End If
                Save_GCode_Dialog(ctl_GCode.GCode_File_Name, False)
...
Early_Exit:
            ...
            If Wizard Then
                ctl_GCode.GCode_File_Name = Wizard_GCode_File_Name
                ctl_GCode.Load_G_Code()
                Load_File_Header()
            Else
                ctl_GCode.GCode_File_Name = ""
            End If
...
#Region "Move Wizard"
    ...
    Private Sub btn_Move_Current_XY_Click(sender As Object, e As EventArgs) Handles btn_Move_Current_XY.Click
        txt_Move_X.Text = Symbol.Get_Value("Sys.Abs_X")
        txt_Move_Y.Text = Symbol.Get_Value("Sys.Abs_Y")
    End Sub

    Private Sub btn_Move_Current_Z_Click(sender As Object, e As EventArgs) Handles btn_Move_Current_Z.Click
        txt_Move_Z.Text = Symbol.Get_Value("Sys.Abs_Y")
    End Sub
...
#Region "Hole Wizard"
    ...
    Private Function Calculate_Hole() As Boolean
        ...
        'Add_Block("M03 M08 G04 P" & CNC.Spindle_Delay)
    ...
    Private Sub btn_txt_Hole_Current_Click(sender As Object, e As EventArgs) Handles btn_txt_Hole_Current.Click
        txt_Hole_Center_X.Text = Symbol.Get_Value("Sys.Abs_X")
        txt_Hole_Center_Y.Text = Symbol.Get_Value("Sys.Abs_Y")
    End Sub
...
#End Region
    ...
    Private Sub btn_Translate_Current_File_Click(sender As Object, e As EventArgs) Handles btn_Translate_Current_File.Click
        txt_Translate_Input_File.Text = ctl_GCode.txt_Folder.Text & "\" & ctl_GCode.txt_File_Name.Text
    End Sub
